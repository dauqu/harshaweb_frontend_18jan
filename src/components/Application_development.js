                    ...
                    <div>
                      <div className="flex items-end flex-wrap justify-evenly max-w-[850px] m-auto">
                        ...
                        <div className="p-6 md:w-[400px] w-full">
                          ...
                          <input type="number" className="w-full outline-none border border-[#d33847] h-[40px] database_chosen text-[#272727] px-3 rounded-sm" defaultValue="" onChange={(event) => {setPN(event.target.value);}}/>
                      ...
                      <div className="flex items-end flex-wrap justify-evenly">
                        <div className="md:w-[400px] w-full p-6">
                          <label htmlFor="" className="text-[#272727] text-[17px] font-semibold">Upload File</label>
                          <input type="file" className="w-full outline-none border border-[#d33847] h-[40px]  text-[#272727] px-3 rounded-sm py-1"  min={1} onChange={(event) => {setFile(event.target.files[0]);}} />
                        </div>
                      </div>
                      <div className="flex items-end flex-wrap justify-evenly">
