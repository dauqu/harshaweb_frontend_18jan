...
function Application_development() {
  ...
  const appRequest = () => {
    ...
    // console.log(file);
    Axios.post(`${API}/application_request`, formdata).then(() => {
      console.log("success");
      console.log(data);
                    ...
                    <div>
                      ...
                      <div className="flex items-end flex-wrap justify-evenly">
                        <div className="md:w-[400px] w-full p-6">
                          ...
                          <input type="file" className="w-full outline-none border border-[#d33847] h-[40px]  text-[#272727] px-3 rounded-sm"  min={1} onChange={(event) => {setFile(event.target.files[0]);}} />
                        </div>
                      </div>
                      <div className="flex items-end flex-wrap justify-evenly">
